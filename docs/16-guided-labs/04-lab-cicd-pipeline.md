...
!!! tip "Интерактивная версия"
    Эту лабу можно прогнать в симуляторе прямо на сайте — с автопроверкой шагов: [Песочница → сценарий «Lab 04»](../21-playground/playground.html?scenario=lab04). Реальные руки — по шагам ниже.
