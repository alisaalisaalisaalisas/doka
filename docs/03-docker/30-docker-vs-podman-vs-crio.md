# Docker vs Podman vs CRI-O

> comparison, CRI-O, containerd, pod, kube
...
comparison, CRI-O, containerd, pod, kube — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
