...
> volumes, bind, tmpfs, mount, propagation
...
volumes, bind, tmpfs, mount, propagation — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
