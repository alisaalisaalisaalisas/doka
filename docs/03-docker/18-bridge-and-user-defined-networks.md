# Bridge и пользовательские сети

> bridge, user-defined, DNS, alias, link
...
bridge, user-defined, DNS, alias, link — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
