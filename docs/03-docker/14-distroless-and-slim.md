# Distroless и slim образы

> distroless, slim, chainguard, hardened
...
distroless, slim, chainguard, hardened — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
