...
> cgroups, capabilities, seccomp, AppArmor
...
cgroups, capabilities, seccomp, AppArmor — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
