# Overlay2 и storage drivers

> overlay2, btrfs, zfs, devicemapper, diff
...
overlay2, btrfs, zfs, devicemapper, diff — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
