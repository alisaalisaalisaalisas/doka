...
> compose spec, profiles, healthcheck, depends_on
...
compose spec, profiles, healthcheck, depends_on — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
