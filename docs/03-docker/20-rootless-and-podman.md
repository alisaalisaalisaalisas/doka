...
> rootless, Podman, slirp4netns, user ns
...
rootless, Podman, slirp4netns, user ns — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
