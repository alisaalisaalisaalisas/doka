# Хардининг production

> read-only, no-new-privileges, user, seccomp, CIS
...
read-only, no-new-privileges, user, seccomp, CIS — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
