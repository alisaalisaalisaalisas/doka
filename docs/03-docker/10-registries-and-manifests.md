# Регистры и манифесты

> registries, manifests, OCI Index, cosign
...
registries, manifests, OCI Index, cosign — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
