...
> dive, slim, layer, cache, .dockerignore
...
dive, slim, layer, cache, .dockerignore — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
