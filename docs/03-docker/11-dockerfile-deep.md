...
> Dockerfile, syntax, parser, LLB, heredoc
...
Dockerfile, syntax, parser, LLB, heredoc — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
