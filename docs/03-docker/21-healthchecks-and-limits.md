# Healthchecks и лимиты

> HEALTHCHECK, resources, pids, restart policies
...
HEALTHCHECK, resources, pids, restart policies — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
