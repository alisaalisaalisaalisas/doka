# Docker API и события

> REST API, events, filters, watch
...
REST API, events, filters, watch — ключевая технология в 03-docker. Понимание архитектуры и жизненного цикла критично для production.
