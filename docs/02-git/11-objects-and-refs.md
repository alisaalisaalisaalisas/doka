# Объекты Git и ссылки

> blobs, trees, commits, refs, HEAD
...
blobs, trees, commits, refs, HEAD — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
