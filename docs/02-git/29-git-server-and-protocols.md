# Git сервер и протоколы

> protocol v2, smart HTTP, SSH, git daemon
...
protocol v2, smart HTTP, SSH, git daemon — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
