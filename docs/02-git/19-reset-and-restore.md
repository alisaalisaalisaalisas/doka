# Reset, restore и checkout

> reset soft/mixed/hard, restore, checkout --patch
...
reset soft/mixed/hard, restore, checkout --patch — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
