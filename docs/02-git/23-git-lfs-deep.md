...
> LFS, track, pointer, smudge, large files
...
LFS, track, pointer, smudge, large files — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
