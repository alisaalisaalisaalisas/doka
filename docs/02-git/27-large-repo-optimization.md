...
> partial clone, sparse, shallow, promisor
...
partial clone, sparse, shallow, promisor — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
