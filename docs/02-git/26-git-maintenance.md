...
> maintenance, commit-graph, mtime, incremental
...
maintenance, commit-graph, mtime, incremental — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
