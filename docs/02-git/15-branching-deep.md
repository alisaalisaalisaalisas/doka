...
> branch, switch, worktree, sparse-checkout
...
branch, switch, worktree, sparse-checkout — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
