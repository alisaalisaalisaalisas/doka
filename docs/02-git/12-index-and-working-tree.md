...
> index, working tree, git status, restore
...
index, working tree, git status, restore — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
