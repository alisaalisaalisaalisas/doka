# Packfiles и сборка мусора

> packfiles, git gc, bitmap, delta
...
packfiles, git gc, bitmap, delta — ключевая технология в 02-git. Понимание архитектуры и жизненного цикла критично для production.
