...
> ServiceAccount, Role, ClusterRole, Binding, can-i
...
ServiceAccount, Role, ClusterRole, Binding, can-i — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
