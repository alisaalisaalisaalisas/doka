...
> API server, etcd, watch, RBAC, audit
...
API server, etcd, watch, RBAC, audit — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
