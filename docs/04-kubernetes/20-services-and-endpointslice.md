...
> services, endpointslice, kube-proxy, iptables/IPVS
...
services, endpointslice, kube-proxy, iptables/IPVS — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
