# Планировщик и контроллеры

> scheduler, controller-manager, informer, workqueue
...
scheduler, controller-manager, informer, workqueue — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
