...
> deployments, rollout, strategy, revision
...
deployments, rollout, strategy, revision — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
