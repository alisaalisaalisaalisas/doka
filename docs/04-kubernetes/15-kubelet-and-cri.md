...
> kubelet, CRI, container runtime, CNI, CSI
...
kubelet, CRI, container runtime, CNI, CSI — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
