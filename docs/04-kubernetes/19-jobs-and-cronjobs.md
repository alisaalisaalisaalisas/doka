...
> jobs, cronjobs, completions, backoff, concurrency
...
jobs, cronjobs, completions, backoff, concurrency — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
