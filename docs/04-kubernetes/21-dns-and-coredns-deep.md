# DNS и CoreDNS глубоко

> DNS, CoreDNS, nodelocal, cache, forward
...
DNS, CoreDNS, nodelocal, cache, forward — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
