...
> pods, initContainers, probes, lifecycle, QoS
...
pods, initContainers, probes, lifecycle, QoS — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
