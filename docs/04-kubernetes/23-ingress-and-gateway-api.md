...
> ingress, GatewayClass, HTTPRoute, TLS, weighted
...
ingress, GatewayClass, HTTPRoute, TLS, weighted — ключевая технология в 04-kubernetes. Понимание архитектуры и жизненного цикла критично для production.
