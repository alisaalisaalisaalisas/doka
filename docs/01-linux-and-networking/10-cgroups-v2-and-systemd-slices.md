# Cgroups v2 и systemd slices

> cgroups v1/v2, slices, CPU/memory limits
...
cgroups v1/v2, slices, CPU/memory limits — ключевая технология в 01-linux-and-networking. Понимание архитектуры и жизненного цикла критично для production.
