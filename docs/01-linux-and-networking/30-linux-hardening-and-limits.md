# Хардининг Linux и лимиты

> ulimit, sysctl, capabilities, seccomp, AppArmor
...
ulimit, sysctl, capabilities, seccomp, AppArmor — ключевая технология в 01-linux-and-networking. Понимание архитектуры и жизненного цикла критично для production.
