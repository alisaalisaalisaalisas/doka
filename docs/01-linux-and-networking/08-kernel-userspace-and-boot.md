# Ядро, userspace и процесс загрузки

> Linux kernel, user space, boot, init, initramfs
...
Linux kernel, user space, boot, init, initramfs — ключевая технология в 01-linux-and-networking. Понимание архитектуры и жизненного цикла критично для production.
