...
> MTU, MSS, ping -M do, fragmentation
...
MTU, MSS, ping -M do, fragmentation — ключевая технология в 01-linux-and-networking. Понимание архитектуры и жизненного цикла критично для production.
