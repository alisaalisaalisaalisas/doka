...
> LogQL, pipeline, JSON, regex, structured metadata
...
LogQL, pipeline, JSON, regex, structured metadata — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
