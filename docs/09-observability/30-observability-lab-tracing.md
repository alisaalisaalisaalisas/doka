...
> OTel → Tempo → Grafana, traces, sampling
...
OTel → Tempo → Grafana, traces, sampling — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
