...
> Sidecar, Store, Query, Compactor, object storage
...
Sidecar, Store, Query, Compactor, object storage — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
