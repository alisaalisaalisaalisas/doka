...
> Elasticsearch, Logstash, Kibana, grok, ILM
...
Elasticsearch, Logstash, Kibana, grok, ILM — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
