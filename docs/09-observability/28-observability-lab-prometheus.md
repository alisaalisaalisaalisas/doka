...
> docker compose, scrape, PromQL, alert
...
docker compose, scrape, PromQL, alert — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
