...
> distributed tracing, spans, Tempo, Jaeger, OTLP
...
distributed tracing, spans, Tempo, Jaeger, OTLP — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
