# Grafana alerting и dashboards as code

> alerting, Terraform, grizzly, as code
...
alerting, Terraform, grizzly, as code — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
