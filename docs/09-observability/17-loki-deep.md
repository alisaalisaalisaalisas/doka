...
> distributor, ingester, querier, chunks, LogQL
...
distributor, ingester, querier, chunks, LogQL — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
