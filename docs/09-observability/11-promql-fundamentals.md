...
> rate, irate, increase, sum by, histogram_quantile
...
rate, irate, increase, sum by, histogram_quantile — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
