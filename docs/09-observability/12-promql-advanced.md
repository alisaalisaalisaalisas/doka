...
> joins, vector matching, label_replace, absent
...
joins, vector matching, label_replace, absent — ключевая технология в 09-observability. Понимание архитектуры и жизненного цикла критично для production.
