...
> cache, artifacts, parallel, DAG, interruptible
...
cache, artifacts, parallel, DAG, interruptible — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
