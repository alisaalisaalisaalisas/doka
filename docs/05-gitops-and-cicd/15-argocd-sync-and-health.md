# Синхронизация и health

> sync policies, hooks, waves, health checks
...
sync policies, hooks, waves, health checks — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
