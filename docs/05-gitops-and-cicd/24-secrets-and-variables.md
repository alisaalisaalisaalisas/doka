...
> variables, protected, masked, vault, OIDC
...
variables, protected, masked, vault, OIDC — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
