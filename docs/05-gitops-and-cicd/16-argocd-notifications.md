...
> notifications, triggers, catalog, Slack/webhook
...
notifications, triggers, catalog, Slack/webhook — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
