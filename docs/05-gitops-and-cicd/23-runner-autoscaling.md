# Автомасштабирование Runner

> autoscaling, fleeting, spot, mixed
...
autoscaling, fleeting, spot, mixed — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
