...
> docker, kubernetes, shell, custom, autoscale
...
docker, kubernetes, shell, custom, autoscale — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
