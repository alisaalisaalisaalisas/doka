...
> artifacts, cache, dependencies, DAG, needs
...
artifacts, cache, dependencies, DAG, needs — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
