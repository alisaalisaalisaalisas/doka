...
> sync fail, drift, health, outofsync
...
sync fail, drift, health, outofsync — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
