# GitLab CI продвинуто

> rules, includes, extends, anchors, DRY
...
rules, includes, extends, anchors, DRY — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
