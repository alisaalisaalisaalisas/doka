...
> Flux, controllers, GitRepository, Kustomization
...
Flux, controllers, GitRepository, Kustomization — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
