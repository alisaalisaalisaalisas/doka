...
> secrets, OIDC, attestation, SLSA, scanning
...
secrets, OIDC, attestation, SLSA, scanning — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
