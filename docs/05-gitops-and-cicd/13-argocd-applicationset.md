...
> ApplicationSet, generators, templating, clusters
...
ApplicationSet, generators, templating, clusters — ключевая технология в 05-gitops-and-cicd. Понимание архитектуры и жизненного цикла критично для production.
